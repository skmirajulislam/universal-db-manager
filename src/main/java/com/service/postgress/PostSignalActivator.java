...
public class PostSignalActivator {
    public static void PostActivator() {
        System.out.println("PostgreSQL Activated. Ready to manage your PostgreSQL database!");
        // We initialize the reader first so we can use it for connection setup AND the
        // main menu
        ...
        System.out.println("1. Use Default Database (Neon DB)");
        ...
        try {
            ...
            if ("2".equals(setupChoice.trim())) {
                ...
                System.out.print("Enter JDBC URL (e.g., jdbc:postgresql://host:port/dbname): ");
                url = reader.readLine();
                ...
                System.out.println("\nUsing default Neon DB credentials...");
                // Default hardcoded credentials
                url = "jdbc:postgresql://ep-wandering-grass-a1h3j6lf-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&prepareThreshold=0";
                user = "neondb_owner";
                password = "npg_kQR12OlXbpdH";
            }
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            // Initialize managers now that we have a guaranteed active connection
                    ...
                    switch (choice) {
                        ...
                        case 7:
                            ...
                            try {
                                ...
                                try (ResultSet colRs = insertMeta.getColumns(null, null, tableName.toLowerCase(), null)) {
                                    while (colRs.next()) {
            ...
            System.exit(1); // The '1' indicates an abnormal termination (error)
        }
    }
}