...
class TableManager {
    ...
    private boolean tableExists(String tableName) throws SQLException {
        ...
        // MySQL metadata searches usually work best with the exact case passed in
    ...
    public void createTable(String tableName) {
        try {
            ...
            // MySQL Dialect Change: INT AUTO_INCREMENT PRIMARY KEY
            String sql = "CREATE TABLE " + tableName + " (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(100))";
    ...
    public void truncateTable(String tableName) {
        try {
            ...
            // MySQL supports TRUNCATE TABLE natively, which is faster than DELETE FROM for
            // clearing tables
