...
public class LiteSignalActivator {
    public static void LiteActivator() {
        System.out.println("SQLite Activated. Ready to manage your SQLite database!");
        ...
        System.out.println("=== SQLite Connection Setup ===");
        System.out.println("1. Use Default Database (local_app.db)");
        System.out.println("2. Enter Custom Database File Name");
        ...
        try {
            ...
            if ("2".equals(setupChoice.trim())) {
                System.out.print("Enter database file name (e.g., my_data.db): ");
                String fileName = reader.readLine();
                // SQLite connection strings look like this: jdbc:sqlite:filename.db
                url = "jdbc:sqlite:" + fileName;
            } else {
                System.out.println("\nUsing default database 'local_app.db'...");
                url = "jdbc:sqlite:local_app.db";
            }
        ...
        // --- CONNECTION ATTEMPT ---
        // Notice we only pass the URL. SQLite doesn't need user/password.
        try (Connection connection = DriverManager.getConnection(url)) {
            ...
            while (true) {
                ...
                System.out.println("6.  Truncate Table (Clear All Data)");
                ...
                System.out.println("18. Delete All Records");
